...
public class menu_drink extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new AdapterMenu(menu_drink.this, newsList);
        list.setAdapter(adapter);
        getAllMenu();
        floatingExit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(menu_drink.this, home_user.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void getAllMenu() {
        ...
        showDialog();
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.GET, BaseURL.dataKategoriMenuDri, null,
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(menu_drink.this, detailMenu.class);
