...
public class menu_mainCourse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_main_course);
        ...
        newsList.clear();
        adapter = new AdapterMenu(menu_mainCourse.this, newsList);
        ...
        floatingExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(menu_mainCourse.this, home_user.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void getAllMenu() {
        ...
        showDialog();
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.GET, BaseURL.dataKategoriMenuMain, null,
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(menu_mainCourse.this, detailMenu.class);
